...
Modified by: Wiktor Sosnowski
- board_size configurable via CLI argument (argv[3])
- separate depth_limit per player (argv[4] for player1, argv[5] for player2)
"""
...
def build_player(player_type: str, player_name: str, depth_limit: int):
